...
<body>
  <?php
	...
	if (array_key_exists('submit', $_REQUEST))
	{
	  ...
	  if ($pdo)
	  {
	    $smt = $pdo->prepare("INSERT INTO cardinalBellarmineAward (Name, `Last Name`, `Class of`) VALUES (:Name, :lastNa, :Class)");
		...
		if($smt->execute())
		{
		  ...
		  echo '<br><br><a href="insertingC.php">Back</a>';
		}
	  }
	}
	else{
	  ?>
      <h1>Insert into the Cardinal Bellarmine Award table here</h1>
	  <form>
        ...
        <br><br><a href="../changes/iuC.html">Back</a>
      </form>
	  <?php } ?>
