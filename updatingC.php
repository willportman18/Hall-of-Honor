...
<head>
<meta charset="UTF-8">
<title>Updating Cardinal Bellarmine Award Table</title>
...
<body>
  <?php
	...
	if (array_key_exists('submit', $_REQUEST))
	{
	  ...
	  if ($pdo)
	  {
	    $smt = $pdo->prepare("UPDATE cardinalBellarmineAward SET Name = :Name, `Last Name` = :lastNa WHERE `Class of` = :Class");
