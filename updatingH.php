...
<head>
<meta charset="UTF-8">
<title>Updating Hall of Fame Table</title>
...
<body>
  <?php
	...
	if (array_key_exists('submit', $_REQUEST))
	{
	  ...
	  {
		$smt 
	    $smt = $pdo->prepare("UPDATE hofAward SET Name = :Name, `Last Name` = :lastNa WHERE `Class of` = :Class");
		...
		if($smt->execute())
		{
		  ...
		  echo '<br><br>'.'<a href="updatingH.php">Back</a>';
		}
	  }
	}
	else{
	  ?>
      <h1>Update the Hall of Fame table here</h1>
	  <form>
		...
		<br><br><a href="../changes/iuH.html">Back</a>
      </form>
	  <?php } ?>
