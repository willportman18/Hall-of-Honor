...
<head>
<meta charset="UTF-8">
<title>Updating John Hanna Award Table</title>
...
<body>
  <?php
	...
	if (array_key_exists('submit', $_REQUEST))
	{
	  ...
	  if ($pdo)
	  {
	    $smt = $pdo->prepare("UPDATE johnHannaAward SET Name = :Name, `Last Name` = :lastNa WHERE `Class of` = :Class");
		...
		if($smt->execute())
		{
		  ...
		  echo '<br><br>'.'<a href="updatingJ.php">Back</a>';
		}
	  }
	}
	else{
	  ?>
      <h1>Update the John Hanna Award table here</h1>
	  <form>
