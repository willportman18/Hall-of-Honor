...
<body>
  <?php
	...
	if (array_key_exists('submit', $_REQUEST))
	{
	  ...
	  if ($pdo)
	  {
	    $smt = $pdo->prepare("INSERT INTO presidents (Name, Start, End) VALUES (:Name, :Start, :End)");
		...
		if($smt->execute())
		{
		  ...
		  echo '<br><br><a href="insertingPre.php">Back</a>';
		}
	  }
	}
	else{
	  ?>
      <h1>Insert into the Presidents table here</h1>
	  <form>
		...
		<input type="submit" name="submit" value="submit">
     	<br><br><a href="../changes/iuPre.html">Back</a>
      </form>
	  <?php } ?>
